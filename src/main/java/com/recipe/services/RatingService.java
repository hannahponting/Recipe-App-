...
public class RatingService {
    ...
    public Rating addRating(Rating rating) {
        if (Stream.of(rating.getRecipe(),rating.getPerson()).anyMatch(Objects::isNull)) {
        ...
        Optional<Rating> existingRating = ratingRepository.findByRecipeIdAndPersonId(rating.getRecipe().getId(), rating.getPerson().getId());
